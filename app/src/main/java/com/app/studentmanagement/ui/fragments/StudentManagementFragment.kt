 ...
 * Use the [StudentManagementFragment.newInstance] factory method to
...
class StudentManagementFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment StudentManagementFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            StudentManagementFragment().apply {
